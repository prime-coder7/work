...
// Fetch counts in one go using COUNT for products
$select_products_count = $conn->prepare(
    "SELECT 
...
$select_products_count->execute([$seller_id]);
$fetch_products_count = $select_products_count->fetch(PDO::FETCH_ASSOC);

$number_of_products = $fetch_products_count['total_products'];
$number_of_active_products = $fetch_products_count['active_products'];
$number_of_inactive_products = $fetch_products_count['inactive_products'];
...
// All Messages
$select_message = $conn->prepare("SELECT * FROM `message` WHERE receiver_id = ?");
        ...
        <section class="dashboard">
            ...
            <div class="box-container">
                ...
                <div class="box profile-box">
                    ...
                    <p><strong>Location:</strong> <?= htmlspecialchars($fetch_profile['address'] ?? 'Not Provided'); ?>
                    </p>
